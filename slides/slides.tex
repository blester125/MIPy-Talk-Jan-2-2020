...
\begin{frame}
    \includegraphics[width=\linewidth]{images/timing-vs-dims-at-100.png}
    \note{
        \begin{itemize}
...
\begin{frame}
    \frametitle{Scaling in the Number of Points}
\end{frame}

\begin{frame}
    \frametitle{Scaling in the Number of Points (subset)}
\end{frame}

\begin{frame}
    \frametitle{Scaling in the Number of Dimensions}
\end{frame}

\begin{frame}
    \frametitle{Timing Curves}
\end{frame}
\end{section} %Results
