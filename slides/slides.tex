...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<4-> You can call python code from inside the cython code (and therefore from inside the C extension)
...
def pairwise_manhattan_numpy_v3(points: np.ndarray) -> np.ndarray:
    ...
    \note<3>{
        \begin{itemize}
            ...
            \item Typing for array shapes has no support which sucks, there are shapes that are expected to make the broadcasting work but you can't communicate these constraints with type hints
        \end{itemize}
    }
\end{frame}
...
\begin{frame}
    ...
    \note{
        \begin{enumerate}
            \item $2x3 + 3 \rightarrow 2x3 + 1x3$
            \item $5x4 + 5x1 \rightarrow 5x4 + 5x4$
            \item $3x4 + 4x3 \rightarrow \text{ERROR}$
        \end{enumerate}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Notebook: \href{https://www.google.com}{Jupyter Notebook}
    \end{itemize}
    \note{
        \begin{itemize}
